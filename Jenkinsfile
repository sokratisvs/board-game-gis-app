      ...
      steps {
        script {
          if (params.TARGET_ENV == 'production') {
            ...
            env.CLIENT_URLS   = "http://production-apps.tail272227.ts.net:${env.FRONTEND_PORT}"
            env.REACT_APP_API_BASE_URL = "http://production-apps.tail272227.ts.net:${env.BACKEND_PORT}"
          } else {
            ...
            env.CLIENT_URLS   = "http://staging-apps.tail272227.ts.net:${env.FRONTEND_PORT}"
            env.REACT_APP_API_BASE_URL = "http://staging-apps.tail272227.ts.net:${env.BACKEND_PORT}"
          }
